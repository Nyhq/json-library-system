...
def login():
    ...
    try:
        ...
        if (
            jObject[username]["Username"] == username
            and jObject[username]["Password"] == password
        ):
...
def withdraw():
    ...
    try:
        ...
        amount = int(
            input("Enter amount you with to withdraw: (Must be a whole number)\n")
        )
    except ValueError:
...
def deposit():
    ...
    try:
        ...
        amount = int(
            input("Enter amount you with to deposit: (Must be a whole number)\n")
        )
    except ValueError:
        # If amount enterred is not an int return an error
        print("Amount must be a whole number!")
...
class SavingsAccount(Account):
    ...
    def createSavingsAccount(self):
        ...
        # Otherwise allow the user to create an account
            ...
            try:
                self.balance = int(
                    input("Enter The Initial deposit: (Must be a whole number)")
                )
            except ValueError:
